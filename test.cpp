...
int main(int argc, char* argv[])
{
	...
	vector nums2 { 4582, 15, 5927, 77, 10, 12308, 4, 110, 101, 6, 890, 29, 4, 50, 102, 3173, 10, 92, 175, 777, 277 };

	rg::sort(nums2, [](const auto& a, const auto& b) { return a == b; });

	zh::sort(nums2, [](const auto& a, const auto& b) { return a == b; });
