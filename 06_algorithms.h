...
namespace zhang::algorithms
{
	...
	namespace namespace_copy
	{
		...
		template <__is_container_or_c_array Container, __is_output_iterator OutputIterator>
	...
	namespace namespace_function
	{
		...
		inline T accumulate(const Container& con, T init, Function fun = _STD plus {}) noexcept
		{
		...
		template <__is_container_or_c_array Container, typename T, class Function = _RANGES equal_to>
		...
		template <__is_container_or_c_array Container, class Function = _RANGES equal_to>
		...
		template <__is_container_or_c_array Container, __is_forward_iterator Iterator>
		...
		template <__is_container_or_c_array Container, class Function = _RANGES less>
		...
		template <__is_container_or_c_array Container, class Function = _RANGES greater>
		...
		template <__is_container_or_c_array Container, __is_output_iterator Iterator, typename Function>
	...
	namespace namespace_binary_search
	{
		...
		template <__is_container_or_c_array Container, typename T, class Function = _RANGES less>
