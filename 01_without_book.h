...
private:
	...
	static constexpr void __print_with_iter(InputIterator first, InputIterator last, Function fun)
	{
	...
	static constexpr void __print_with_basic_mag(const T& msg, Args&&... args) noexcept
	{
	...
	static constexpr void __print_with_c_pointer(C_pointer first, C_pointer last, Function fun = {})
	{
